let formidable,requireSignin;_227‍.w("express-formidable",[["default",["formidable"],function(v){formidable=v}]]);_227‍.w("../middlewares",[["requireSignin",["requireSignin"],function(v){requireSignin=v}]]);
...
module.exports = (app) => {
  ...
  router.get("/user", requireSignin, user.findOne);
