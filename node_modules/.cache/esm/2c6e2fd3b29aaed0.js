let User,jwt;_b29‍.w("../models/user-model",[["default",["User"],function(v){User=v}]]);_b29‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
...
const sendemail = (receiver, subject, html) => {
  ...
  _b29‍.g.console.log(mailOptions);
  transport.sendMail(mailOptions, function (error, info) {
    if (error) {
      _b29‍.g.console.log(error);
    } else {
      _b29‍.g.console.log("Email sent: " + info.response);
    }
  });
};
