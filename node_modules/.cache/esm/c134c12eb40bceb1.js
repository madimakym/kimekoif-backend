let User,jwt;_b40‍.w("../models/user-model",[["default",["User"],function(v){User=v}]]);_b40‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
...
const sendemail = (receiver, subject, html) => {
  ...
  _b40‍.g.console.log(mailOptions);
  transport.sendMail(mailOptions, function (error, info) {
    if (error) {
      _b40‍.g.console.log(error);
    } else {
      _b40‍.g.console.log("Email sent: " + info.response);
    }
  });
};
