let User,jwt;_6ad‍.w("../models/user-model",[["default",["User"],function(v){User=v}]]);_6ad‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
...
const sendemail = (receiver, subject, html) => {
  ...
  _6ad‍.g.console.log(mailOptions);
  transport.sendMail(mailOptions, function (error, info) {
    if (error) {
      _6ad‍.g.console.log(error);
    } else {
      _6ad‍.g.console.log("Email sent: " + info.response);
    }
  });
};
