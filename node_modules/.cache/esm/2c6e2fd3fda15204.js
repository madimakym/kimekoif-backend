let User,jwt;_fda‍.w("../models/user-model",[["default",["User"],function(v){User=v}]]);_fda‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
...
const sendemail = (receiver, subject, html) => {
  ...
  _fda‍.g.console.log(mailOptions);
  transport.sendMail(mailOptions, function (error, info) {
    if (error) {
      _fda‍.g.console.log(error);
    } else {
      _fda‍.g.console.log("Email sent: " + info.response);
    }
  });
};
